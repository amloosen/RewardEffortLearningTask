...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/alisaloosen/Documents/GitHub/RewardEffortLearningTask/RewardEffortLearningTask.py',
...
box1 = visual.Rect(
    ...
    lineWidth=5.0,     colorSpace='rgb',  lineColor=[0.3569, 0.6941, 0.8039], fillColor=[1.0000, 1.0000, 1.0000],
...
instructionquiz = data.TrialHandler(nReps=1.0, method='sequential', 
...
for thisInstructionquiz in instructionquiz:
    ...
    text_1.setText(resp1)
    text_2.setText(resp2)
    text_3.setText(resp3)
...
# keep track of which components have finished
practice_instructionsComponents = [practice_intro_text1, practice_intro_text2, practice_start]
